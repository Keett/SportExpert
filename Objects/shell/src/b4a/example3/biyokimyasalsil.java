...
public class biyokimyasalsil implements IRemote{
	public static biyokimyasalsil mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public biyokimyasalsil() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("biyokimyasalsil"), "b4a.example3.biyokimyasalsil");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, biyokimyasalsil.class);
...
public static RemoteObject _buttonbiyokimyasalaciklama = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
...
public static RemoteObject _buttonbiyokimyasaltabloveri = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _buttonbiyokimyasalekle = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
...
public static b4a.example3.programsec _programsec = null;
  public Object[] GetGlobals() {
		return new Object[] {"aciklama",biyokimyasalsil.mostCurrent._aciklama,"Activity",biyokimyasalsil.mostCurrent._activity,"AnaMenu",Debug.moduleToString(b4a.example3.anamenu.class),"AntranorGorusEkle",Debug.moduleToString(b4a.example3.antranorgorusekle.class),"AntranorGorusListele",Debug.moduleToString(b4a.example3.antranorgoruslistele.class),"AntranorGorusSil",Debug.moduleToString(b4a.example3.antranorgorussil.class),"AntropometrikEkle",Debug.moduleToString(b4a.example3.antropometrikekle.class),"AntropometrikListele",Debug.moduleToString(b4a.example3.antropometriklistele.class),"AntropometrikSil",Debug.moduleToString(b4a.example3.antropometriksil.class),"BiyokimyasalEkle",Debug.moduleToString(b4a.example3.biyokimyasalekle.class),"BiyokimyasalListele",Debug.moduleToString(b4a.example3.biyokimyasallistele.class),"bmp",biyokimyasalsil.mostCurrent._bmp,"ButtonAnasayfa",biyokimyasalsil.mostCurrent._buttonanasayfa,"ButtonBiyokimyasalAciklama",biyokimyasalsil.mostCurrent._buttonbiyokimyasalaciklama,"ButtonBiyokimyasalEkle",biyokimyasalsil.mostCurrent._buttonbiyokimyasalekle,"ButtonBiyokimyasalTabloVeri",biyokimyasalsil.mostCurrent._buttonbiyokimyasaltabloveri,"ButtonIsim",biyokimyasalsil.mostCurrent._buttonisim,"ButtonTarih",biyokimyasalsil.mostCurrent._buttontarih,"ButtonTc",biyokimyasalsil.mostCurrent._buttontc,"Color",Debug.moduleToString(b4a.example3.color.class),"DateUtils",biyokimyasalsil.mostCurrent._dateutils,"DayaniklilikTestEkle",Debug.moduleToString(b4a.example3.dayanikliliktestekle.class),"DayaniklilikTestListele",Debug.moduleToString(b4a.example3.dayanikliliktestlistele.class),"DayaniklilikTestMenu",Debug.moduleToString(b4a.example3.dayanikliliktestmenu.class),"DayaniklilikTestSil",Debug.moduleToString(b4a.example3.dayanikliliktestsil.class),"DBUtils",Debug.moduleToString(b4a.example3.dbutils.class),"DenekDuzenleSil",Debug.moduleToString(b4a.example3.denekduzenlesil.class),"DenekEkleGuncelle",Debug.moduleToString(b4a.example3.denekekleguncelle.class),"DenekListele",Debug.moduleToString(b4a.example3.deneklistele.class),"DengeTest",Debug.moduleToString(b4a.example3.dengetest.class),"DikeySicramaTest",Debug.moduleToString(b4a.example3.dikeysicramatest.class),"EditTextAra",biyokimyasalsil.mostCurrent._edittextara,"GelismisTestDenekAra",Debug.moduleToString(b4a.example3.gelismistestdenekara.class),"id",biyokimyasalsil._id,"InsertVeriler",Debug.moduleToString(b4a.example3.insertveriler.class),"isim",biyokimyasalsil.mostCurrent._isim,"KuvvetTest",Debug.moduleToString(b4a.example3.kuvvettest.class),"LabelCarpi",biyokimyasalsil.mostCurrent._labelcarpi,"ListView1",biyokimyasalsil.mostCurrent._listview1,"Main",Debug.moduleToString(b4a.example3.main.class),"MotorOzellikMenu",Debug.moduleToString(b4a.example3.motorozellikmenu.class),"ProgramAyar",Debug.moduleToString(b4a.example3.programayar.class),"ProgramListele",Debug.moduleToString(b4a.example3.programlistele.class),"ProgramSec",Debug.moduleToString(b4a.example3.programsec.class),"ProgramSil",Debug.moduleToString(b4a.example3.programsil.class),"ProgramVeri",Debug.moduleToString(b4a.example3.programveri.class),"PsikolojikEkle",Debug.moduleToString(b4a.example3.psikolojikekle.class),"PsikolojikListele",Debug.moduleToString(b4a.example3.psikolojiklistele.class),"PsikolojikSil",Debug.moduleToString(b4a.example3.psikolojiksil.class),"ReaksiyonTest",Debug.moduleToString(b4a.example3.reaksiyontest.class),"resim",biyokimyasalsil._resim,"rs",biyokimyasalsil.mostCurrent._rs,"saat",biyokimyasalsil.mostCurrent._saat,"SaglikBilgileriEkle",Debug.moduleToString(b4a.example3.saglikbilgileriekle.class),"SaglikBilgileriListele",Debug.moduleToString(b4a.example3.saglikbilgilerilistele.class),"SaglikBilgileriSil",Debug.moduleToString(b4a.example3.saglikbilgilerisil.class),"SesService",Debug.moduleToString(b4a.example3.sesservice.class),"Starter",Debug.moduleToString(b4a.example3.starter.class),"SuratTestAyar",Debug.moduleToString(b4a.example3.surattestayar.class),"SuratTestEkle",Debug.moduleToString(b4a.example3.surattestekle.class),"SuratTestListele",Debug.moduleToString(b4a.example3.surattestlistele.class),"SuratTestSil",Debug.moduleToString(b4a.example3.surattestsil.class),"tarih",biyokimyasalsil.mostCurrent._tarih,"tc",biyokimyasalsil.mostCurrent._tc,"TestDenekAra",Debug.moduleToString(b4a.example3.testdenekara.class),"TestMenu",Debug.moduleToString(b4a.example3.testmenu.class),"WebView1",biyokimyasalsil.mostCurrent._webview1};
}
}