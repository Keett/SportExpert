...
public class dayanikliliktestlistele implements IRemote{
	public static dayanikliliktestlistele mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public dayanikliliktestlistele() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("dayanikliliktestlistele"), "b4a.example3.dayanikliliktestlistele");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, dayanikliliktestlistele.class);
...
public static RemoteObject _buttondayanikliliktestekle = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
...
public static RemoteObject _buttondenektc = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _buttondenekisim = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
...
public static RemoteObject _buttonmekiksayisi = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
