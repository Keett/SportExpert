...
public class dayanikliliktestsil implements IRemote{
	public static dayanikliliktestsil mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public dayanikliliktestsil() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("dayanikliliktestsil"), "b4a.example3.dayanikliliktestsil");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, dayanikliliktestsil.class);
