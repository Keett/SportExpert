...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("b4a.example3.dbutils");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("dbutils"), "b4a.example3.dbutils");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("b4a.example3.dbutils"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
