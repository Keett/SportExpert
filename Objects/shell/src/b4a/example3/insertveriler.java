...
public class insertveriler implements IRemote{
	public static insertveriler mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public insertveriler() {
		mostCurrent = this;
	}
...
public boolean isSingleton() {
     ...
     private static PCBA pcBA = new PCBA(null, insertveriler.class);
    static {
		mostCurrent = new insertveriler();
        remoteMe = RemoteObject.declareNull("b4a.example3.insertveriler");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("insertveriler"), "b4a.example3.insertveriler");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("b4a.example3.insertveriler"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
