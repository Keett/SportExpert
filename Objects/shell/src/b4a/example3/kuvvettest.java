...
public class kuvvettest implements IRemote{
	public static kuvvettest mostCurrent;
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("kuvvettest"), "b4a.example3.kuvvettest");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, kuvvettest.class);
