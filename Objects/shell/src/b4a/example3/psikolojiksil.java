...
public class psikolojiksil implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("psikolojiksil"), "b4a.example3.psikolojiksil");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, psikolojiksil.class);
...
public static RemoteObject _buttonpsikolojikaciklama = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
...
public static RemoteObject _psikolojik_aciklama = RemoteObject.createImmutable("");
...
public static b4a.example3.programsec _programsec = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",psikolojiksil.mostCurrent._activity,"AnaMenu",Debug.moduleToString(b4a.example3.anamenu.class),"AntranorGorusEkle",Debug.moduleToString(b4a.example3.antranorgorusekle.class),"AntranorGorusListele",Debug.moduleToString(b4a.example3.antranorgoruslistele.class),"AntranorGorusSil",Debug.moduleToString(b4a.example3.antranorgorussil.class),"AntropometrikEkle",Debug.moduleToString(b4a.example3.antropometrikekle.class),"AntropometrikListele",Debug.moduleToString(b4a.example3.antropometriklistele.class),"AntropometrikSil",Debug.moduleToString(b4a.example3.antropometriksil.class),"BiyokimyasalEkle",Debug.moduleToString(b4a.example3.biyokimyasalekle.class),"BiyokimyasalListele",Debug.moduleToString(b4a.example3.biyokimyasallistele.class),"BiyokimyasalSil",Debug.moduleToString(b4a.example3.biyokimyasalsil.class),"bmp",psikolojiksil.mostCurrent._bmp,"ButtonAnasayfa",psikolojiksil.mostCurrent._buttonanasayfa,"ButtonIsim",psikolojiksil.mostCurrent._buttonisim,"ButtonPsikolojikAciklama",psikolojiksil.mostCurrent._buttonpsikolojikaciklama,"ButtonTarih",psikolojiksil.mostCurrent._buttontarih,"ButtonTc",psikolojiksil.mostCurrent._buttontc,"Color",Debug.moduleToString(b4a.example3.color.class),"DateUtils",psikolojiksil.mostCurrent._dateutils,"DayaniklilikTestEkle",Debug.moduleToString(b4a.example3.dayanikliliktestekle.class),"DayaniklilikTestListele",Debug.moduleToString(b4a.example3.dayanikliliktestlistele.class),"DayaniklilikTestMenu",Debug.moduleToString(b4a.example3.dayanikliliktestmenu.class),"DayaniklilikTestSil",Debug.moduleToString(b4a.example3.dayanikliliktestsil.class),"DBUtils",Debug.moduleToString(b4a.example3.dbutils.class),"DenekDuzenleSil",Debug.moduleToString(b4a.example3.denekduzenlesil.class),"DenekEkleGuncelle",Debug.moduleToString(b4a.example3.denekekleguncelle.class),"DenekListele",Debug.moduleToString(b4a.example3.deneklistele.class),"DengeTest",Debug.moduleToString(b4a.example3.dengetest.class),"DikeySicramaTest",Debug.moduleToString(b4a.example3.dikeysicramatest.class),"EditTextAra",psikolojiksil.mostCurrent._edittextara,"GelismisTestDenekAra",Debug.moduleToString(b4a.example3.gelismistestdenekara.class),"id",psikolojiksil._id,"InsertVeriler",Debug.moduleToString(b4a.example3.insertveriler.class),"isim",psikolojiksil.mostCurrent._isim,"KuvvetTest",Debug.moduleToString(b4a.example3.kuvvettest.class),"LabelCarpi",psikolojiksil.mostCurrent._labelcarpi,"ListView1",psikolojiksil.mostCurrent._listview1,"Main",Debug.moduleToString(b4a.example3.main.class),"MotorOzellikMenu",Debug.moduleToString(b4a.example3.motorozellikmenu.class),"ProgramAyar",Debug.moduleToString(b4a.example3.programayar.class),"ProgramListele",Debug.moduleToString(b4a.example3.programlistele.class),"ProgramSec",Debug.moduleToString(b4a.example3.programsec.class),"ProgramSil",Debug.moduleToString(b4a.example3.programsil.class),"ProgramVeri",Debug.moduleToString(b4a.example3.programveri.class),"psikolojik_aciklama",psikolojiksil.mostCurrent._psikolojik_aciklama,"PsikolojikEkle",Debug.moduleToString(b4a.example3.psikolojikekle.class),"PsikolojikListele",Debug.moduleToString(b4a.example3.psikolojiklistele.class),"ReaksiyonTest",Debug.moduleToString(b4a.example3.reaksiyontest.class),"resim",psikolojiksil._resim,"rs",psikolojiksil.mostCurrent._rs,"saat",psikolojiksil.mostCurrent._saat,"SaglikBilgileriEkle",Debug.moduleToString(b4a.example3.saglikbilgileriekle.class),"SaglikBilgileriListele",Debug.moduleToString(b4a.example3.saglikbilgilerilistele.class),"SaglikBilgileriSil",Debug.moduleToString(b4a.example3.saglikbilgilerisil.class),"SesService",Debug.moduleToString(b4a.example3.sesservice.class),"Starter",Debug.moduleToString(b4a.example3.starter.class),"SuratTestAyar",Debug.moduleToString(b4a.example3.surattestayar.class),"SuratTestEkle",Debug.moduleToString(b4a.example3.surattestekle.class),"SuratTestListele",Debug.moduleToString(b4a.example3.surattestlistele.class),"SuratTestSil",Debug.moduleToString(b4a.example3.surattestsil.class),"tarih",psikolojiksil.mostCurrent._tarih,"tc",psikolojiksil.mostCurrent._tc,"TestDenekAra",Debug.moduleToString(b4a.example3.testdenekara.class),"TestMenu",Debug.moduleToString(b4a.example3.testmenu.class),"WebView1",psikolojiksil.mostCurrent._webview1};
}
}