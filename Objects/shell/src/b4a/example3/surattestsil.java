...
public class surattestsil implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("surattestsil"), "b4a.example3.surattestsil");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, surattestsil.class);
...
public static RemoteObject _moddeger = RemoteObject.createImmutable("");
public static RemoteObject _id = RemoteObject.createImmutable(0);
public static RemoteObject _gate_sayisi = RemoteObject.createImmutable(0);
public static RemoteObject _set_sayisi = RemoteObject.createImmutable(0);
...
public static RemoteObject _buttonsurattestekle = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _buttontablodagoster = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
...
public static RemoteObject _buttonmod = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _buttontarih = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _buttongatesayisi = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _buttonsetsayisi = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
...
public static b4a.example3.programsec _programsec = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",surattestsil.mostCurrent._activity,"AnaMenu",Debug.moduleToString(b4a.example3.anamenu.class),"AntranorGorusEkle",Debug.moduleToString(b4a.example3.antranorgorusekle.class),"AntranorGorusListele",Debug.moduleToString(b4a.example3.antranorgoruslistele.class),"AntranorGorusSil",Debug.moduleToString(b4a.example3.antranorgorussil.class),"AntropometrikEkle",Debug.moduleToString(b4a.example3.antropometrikekle.class),"AntropometrikListele",Debug.moduleToString(b4a.example3.antropometriklistele.class),"AntropometrikSil",Debug.moduleToString(b4a.example3.antropometriksil.class),"BiyokimyasalEkle",Debug.moduleToString(b4a.example3.biyokimyasalekle.class),"BiyokimyasalListele",Debug.moduleToString(b4a.example3.biyokimyasallistele.class),"BiyokimyasalSil",Debug.moduleToString(b4a.example3.biyokimyasalsil.class),"bmp",surattestsil.mostCurrent._bmp,"ButtonAnasayfa",surattestsil.mostCurrent._buttonanasayfa,"ButtonGateSayisi",surattestsil.mostCurrent._buttongatesayisi,"ButtonIsim",surattestsil.mostCurrent._buttonisim,"ButtonMod",surattestsil.mostCurrent._buttonmod,"ButtonSetSayisi",surattestsil.mostCurrent._buttonsetsayisi,"ButtonSuratTestEkle",surattestsil.mostCurrent._buttonsurattestekle,"ButtonTablodaGoster",surattestsil.mostCurrent._buttontablodagoster,"ButtonTarih",surattestsil.mostCurrent._buttontarih,"ButtonTc",surattestsil.mostCurrent._buttontc,"Color",Debug.moduleToString(b4a.example3.color.class),"DateUtils",surattestsil.mostCurrent._dateutils,"DayaniklilikTestEkle",Debug.moduleToString(b4a.example3.dayanikliliktestekle.class),"DayaniklilikTestListele",Debug.moduleToString(b4a.example3.dayanikliliktestlistele.class),"DayaniklilikTestMenu",Debug.moduleToString(b4a.example3.dayanikliliktestmenu.class),"DayaniklilikTestSil",Debug.moduleToString(b4a.example3.dayanikliliktestsil.class),"DBUtils",Debug.moduleToString(b4a.example3.dbutils.class),"DenekDuzenleSil",Debug.moduleToString(b4a.example3.denekduzenlesil.class),"DenekEkleGuncelle",Debug.moduleToString(b4a.example3.denekekleguncelle.class),"DenekListele",Debug.moduleToString(b4a.example3.deneklistele.class),"DengeTest",Debug.moduleToString(b4a.example3.dengetest.class),"DikeySicramaTest",Debug.moduleToString(b4a.example3.dikeysicramatest.class),"EditTextAra",surattestsil.mostCurrent._edittextara,"gate_sayisi",surattestsil._gate_sayisi,"GelismisTestDenekAra",Debug.moduleToString(b4a.example3.gelismistestdenekara.class),"id",surattestsil._id,"InsertVeriler",Debug.moduleToString(b4a.example3.insertveriler.class),"isim",surattestsil.mostCurrent._isim,"KuvvetTest",Debug.moduleToString(b4a.example3.kuvvettest.class),"LabelCarpi",surattestsil.mostCurrent._labelcarpi,"ListView1",surattestsil.mostCurrent._listview1,"Main",Debug.moduleToString(b4a.example3.main.class),"modDeger",surattestsil.mostCurrent._moddeger,"MotorOzellikMenu",Debug.moduleToString(b4a.example3.motorozellikmenu.class),"ProgramAyar",Debug.moduleToString(b4a.example3.programayar.class),"ProgramListele",Debug.moduleToString(b4a.example3.programlistele.class),"ProgramSec",Debug.moduleToString(b4a.example3.programsec.class),"ProgramSil",Debug.moduleToString(b4a.example3.programsil.class),"ProgramVeri",Debug.moduleToString(b4a.example3.programveri.class),"PsikolojikEkle",Debug.moduleToString(b4a.example3.psikolojikekle.class),"PsikolojikListele",Debug.moduleToString(b4a.example3.psikolojiklistele.class),"PsikolojikSil",Debug.moduleToString(b4a.example3.psikolojiksil.class),"ReaksiyonTest",Debug.moduleToString(b4a.example3.reaksiyontest.class),"resim",surattestsil._resim,"rs",surattestsil.mostCurrent._rs,"saat",surattestsil.mostCurrent._saat,"SaglikBilgileriEkle",Debug.moduleToString(b4a.example3.saglikbilgileriekle.class),"SaglikBilgileriListele",Debug.moduleToString(b4a.example3.saglikbilgilerilistele.class),"SaglikBilgileriSil",Debug.moduleToString(b4a.example3.saglikbilgilerisil.class),"SesService",Debug.moduleToString(b4a.example3.sesservice.class),"set_sayisi",surattestsil._set_sayisi,"Starter",Debug.moduleToString(b4a.example3.starter.class),"SuratTestAyar",Debug.moduleToString(b4a.example3.surattestayar.class),"SuratTestEkle",Debug.moduleToString(b4a.example3.surattestekle.class),"SuratTestListele",Debug.moduleToString(b4a.example3.surattestlistele.class),"tarih",surattestsil.mostCurrent._tarih,"tc",surattestsil.mostCurrent._tc,"TestDenekAra",Debug.moduleToString(b4a.example3.testdenekara.class),"TestMenu",Debug.moduleToString(b4a.example3.testmenu.class),"WebView1",surattestsil.mostCurrent._webview1};
}
}