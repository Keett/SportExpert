...
public class anamenu extends Activity implements B4AActivity{
	public static anamenu mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example3", "b4a.example3.anamenu");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (anamenu).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example3", "b4a.example3.anamenu");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example3.anamenu", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (anamenu) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (anamenu) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (anamenu) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public anywheresoftware.b4a.objects.ButtonWrapper _buttondenek = null;
public anywheresoftware.b4a.objects.LabelWrapper _labeldenek = null;
public anywheresoftware.b4a.objects.ButtonWrapper _buttontest = null;
public anywheresoftware.b4a.objects.LabelWrapper _labeltest = null;
public anywheresoftware.b4a.objects.LabelWrapper _labelraporlama = null;
public anywheresoftware.b4a.objects.LabelWrapper _labelayarlar = null;
public anywheresoftware.b4a.objects.LabelWrapper _labelyardimklavuzu = null;
public anywheresoftware.b4a.objects.ButtonWrapper _buttonayarlar = null;
public anywheresoftware.b4a.objects.ButtonWrapper _buttonyardimklavuzu = null;
...
RDebugUtils.currentModule="anamenu";
if (Debug.shouldDelegate(mostCurrent.activityBA, "activity_create", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "activity_create", new Object[] {_firsttime}));}
RDebugUtils.currentLine=37683200;
 //BA.debugLineNum = 37683200;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=37683202;
 //BA.debugLineNum = 37683202;BA.debugLine="Activity.LoadLayout(\"AnasayfaPage\")";
mostCurrent._activity.LoadLayout("AnasayfaPage",mostCurrent.activityBA);
...
RDebugUtils.currentLine=37814272;
 //BA.debugLineNum = 37814272;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
...
RDebugUtils.currentLine=37748736;
 //BA.debugLineNum = 37748736;BA.debugLine="Sub Activity_Resume";
...
RDebugUtils.currentLine=38207488;
 //BA.debugLineNum = 38207488;BA.debugLine="Sub ButtonAnasayfa_Click";
RDebugUtils.currentLine=38207489;
 //BA.debugLineNum = 38207489;BA.debugLine="Return";
if (true) return "";
...
RDebugUtils.currentLine=38076416;
 //BA.debugLineNum = 38076416;BA.debugLine="Sub ButtonAyarlar_Click";
RDebugUtils.currentLine=38076418;
 //BA.debugLineNum = 38076418;BA.debugLine="End Sub";
return "";
}
public static String  _buttondenek_click() throws Exception{
RDebugUtils.currentModule="anamenu";
if (Debug.shouldDelegate(mostCurrent.activityBA, "buttondenek_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "buttondenek_click", null));}
RDebugUtils.currentLine=37879808;
 //BA.debugLineNum = 37879808;BA.debugLine="Sub ButtonDenek_Click";
RDebugUtils.currentLine=37879809;
 //BA.debugLineNum = 37879809;BA.debugLine="StartActivity(DenekListele)";
...
public static String  _buttonraporlama_click() throws Exception{
RDebugUtils.currentModule="anamenu";
if (Debug.shouldDelegate(mostCurrent.activityBA, "buttonraporlama_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "buttonraporlama_click", null));}
RDebugUtils.currentLine=38010880;
 //BA.debugLineNum = 38010880;BA.debugLine="Sub ButtonRaporlama_Click";
RDebugUtils.currentLine=38010882;
 //BA.debugLineNum = 38010882;BA.debugLine="End Sub";
return "";
}
public static String  _buttontest_click() throws Exception{
RDebugUtils.currentModule="anamenu";
if (Debug.shouldDelegate(mostCurrent.activityBA, "buttontest_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "buttontest_click", null));}
RDebugUtils.currentLine=37945344;
 //BA.debugLineNum = 37945344;BA.debugLine="Sub ButtonTest_Click";
RDebugUtils.currentLine=37945345;
 //BA.debugLineNum = 37945345;BA.debugLine="StartActivity(TestMenu)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._testmenu.getObject()));
RDebugUtils.currentLine=37945346;
 //BA.debugLineNum = 37945346;BA.debugLine="End Sub";
return "";
}
public static String  _buttonyardimklavuzu_click() throws Exception{
RDebugUtils.currentModule="anamenu";
if (Debug.shouldDelegate(mostCurrent.activityBA, "buttonyardimklavuzu_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "buttonyardimklavuzu_click", null));}
RDebugUtils.currentLine=38141952;
 //BA.debugLineNum = 38141952;BA.debugLine="Sub ButtonYardimKlavuzu_Click";
