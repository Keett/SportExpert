...
public class antranorgorusekle extends Activity implements B4AActivity{
	public static antranorgorusekle mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example3", "b4a.example3.antranorgorusekle");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (antranorgorusekle).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example3", "b4a.example3.antranorgorusekle");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example3.antranorgorusekle", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (antranorgorusekle) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (antranorgorusekle) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return antranorgorusekle.class;
	}
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (antranorgorusekle) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            antranorgorusekle mc = mostCurrent;
...
public anywheresoftware.b4a.objects.EditTextWrapper _edittextantranorgorusleriaciklama = null;
public anywheresoftware.b4a.objects.LabelWrapper _labelantranorgorusleriaciklama = null;
public anywheresoftware.b4a.objects.ButtonWrapper _buttonantranorgorusleriekle = null;
public static int _antranorgorusleriid = 0;
...
RDebugUtils.currentModule="antranorgorusekle";
if (Debug.shouldDelegate(mostCurrent.activityBA, "activity_create", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "activity_create", new Object[] {_firsttime}));}
RDebugUtils.currentLine=11599872;
 //BA.debugLineNum = 11599872;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=11599874;
 //BA.debugLineNum = 11599874;BA.debugLine="Activity.LoadLayout(\"AntranorGorusleriEklePage\")";
mostCurrent._activity.LoadLayout("AntranorGorusleriEklePage",mostCurrent.activityBA);
RDebugUtils.currentLine=11599877;
 //BA.debugLineNum = 11599877;BA.debugLine="LabelAntranorGorusleriAciklama.TextColor = Colors";
mostCurrent._labelantranorgorusleriaciklama.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
RDebugUtils.currentLine=11599878;
 //BA.debugLineNum = 11599878;BA.debugLine="LabelAntranorGorusleriAciklama.TextSize = 20";
mostCurrent._labelantranorgorusleriaciklama.setTextSize((float) (20));
RDebugUtils.currentLine=11599879;
 //BA.debugLineNum = 11599879;BA.debugLine="LabelAntranorGorusleriAciklama.Typeface = Typefac";
mostCurrent._labelantranorgorusleriaciklama.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD);
RDebugUtils.currentLine=11599881;
 //BA.debugLineNum = 11599881;BA.debugLine="WebView1.ZoomEnabled = True";
mostCurrent._webview1.setZoomEnabled(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=11599882;
 //BA.debugLineNum = 11599882;BA.debugLine="WebView1.JavaScriptEnabled = True";
mostCurrent._webview1.setJavaScriptEnabled(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=11599884;
 //BA.debugLineNum = 11599884;BA.debugLine="EditTextAntranorGorusleriAciklama.TextColor = Col";
mostCurrent._edittextantranorgorusleriaciklama.setTextColor(mostCurrent._color._koyumavi /*int*/ );
RDebugUtils.currentLine=11599885;
 //BA.debugLineNum = 11599885;BA.debugLine="EditTextAntranorGorusleriAciklama.Hint = \"Antranö";
mostCurrent._edittextantranorgorusleriaciklama.setHint("Antranör görüşlerinizi bu alana yazabilirsiniz..");
RDebugUtils.currentLine=11599886;
 //BA.debugLineNum = 11599886;BA.debugLine="EditTextAntranorGorusleriAciklama.HintColor = Col";
mostCurrent._edittextantranorgorusleriaciklama.setHintColor(mostCurrent._color._acikmavi /*int*/ );
RDebugUtils.currentLine=11599887;
 //BA.debugLineNum = 11599887;BA.debugLine="EditTextAntranorGorusleriAciklama.TextSize = 20";
mostCurrent._edittextantranorgorusleriaciklama.setTextSize((float) (20));
RDebugUtils.currentLine=11599888;
 //BA.debugLineNum = 11599888;BA.debugLine="EditTextAntranorGorusleriAciklama.Typeface = Type";
mostCurrent._edittextantranorgorusleriaciklama.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT);
RDebugUtils.currentLine=11599892;
 //BA.debugLineNum = 11599892;BA.debugLine="HTMLGosterDB";
_htmlgosterdb();
...
RDebugUtils.currentLine=11796480;
 //BA.debugLineNum = 11796480;BA.debugLine="Sub HTMLGosterDB";
RDebugUtils.currentLine=11796482;
 //BA.debugLineNum = 11796482;BA.debugLine="WebView1.LoadHtml(DBUtils.ExecuteHtml(Main.sql,\"S";
...
RDebugUtils.currentLine=11927552;
 //BA.debugLineNum = 11927552;BA.debugLine="Sub ButtonAntranorGorusleriEkle_Click";
RDebugUtils.currentLine=11927553;
 //BA.debugLineNum = 11927553;BA.debugLine="Dim result As Int";
_result = 0;
RDebugUtils.currentLine=11927554;
 //BA.debugLineNum = 11927554;BA.debugLine="result = Msgbox2(\"Antranor Görüşlerini eklemek is";
_result = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Antranor Görüşlerini eklemek istiyor musunuz?:"),BA.ObjectToCharSequence("Onay Mesajı"),"Evet","","Hayır",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
RDebugUtils.currentLine=11927555;
 //BA.debugLineNum = 11927555;BA.debugLine="If result= DialogResponse.POSITIVE Then";
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
RDebugUtils.currentLine=11927556;
 //BA.debugLineNum = 11927556;BA.debugLine="Dim now As Long = DateTime.Now";
_now = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
RDebugUtils.currentLine=11927557;
 //BA.debugLineNum = 11927557;BA.debugLine="DateTime.DateFormat = \"dd/MM/yyyy\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("dd/MM/yyyy");
RDebugUtils.currentLine=11927558;
 //BA.debugLineNum = 11927558;BA.debugLine="Log(DateTime.Date(now))";
anywheresoftware.b4a.keywords.Common.LogImpl("211927558",anywheresoftware.b4a.keywords.Common.DateTime.Date(_now),0);
RDebugUtils.currentLine=11927559;
 //BA.debugLineNum = 11927559;BA.debugLine="secilenTarih = DateTime.Date(now)";
mostCurrent._secilentarih = anywheresoftware.b4a.keywords.Common.DateTime.Date(_now);
RDebugUtils.currentLine=11927560;
 //BA.debugLineNum = 11927560;BA.debugLine="Log(DateTime.Time(now))";
anywheresoftware.b4a.keywords.Common.LogImpl("211927560",anywheresoftware.b4a.keywords.Common.DateTime.Time(_now),0);
RDebugUtils.currentLine=11927561;
 //BA.debugLineNum = 11927561;BA.debugLine="secilenSaat = DateTime.Time(now)";
mostCurrent._secilensaat = anywheresoftware.b4a.keywords.Common.DateTime.Time(_now);
RDebugUtils.currentLine=11927562;
 //BA.debugLineNum = 11927562;BA.debugLine="ID";
_id();
RDebugUtils.currentLine=11927563;
 //BA.debugLineNum = 11927563;BA.debugLine="Main.sql.ExecNonQuery2(\"INSERT INTO AntranorGoru";
mostCurrent._main._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2("INSERT INTO AntranorGorusleri VALUES(?,?,?,?,?)",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(_antranorgorusleriid),(Object)(mostCurrent._testdenekara._secilendenek /*String*/ ),(Object)(mostCurrent._secilentarih),(Object)(mostCurrent._secilensaat),(Object)(mostCurrent._edittextantranorgorusleriaciklama.getText())}));
RDebugUtils.currentLine=11927564;
 //BA.debugLineNum = 11927564;BA.debugLine="Log(\"Antranor görüşleri eklendi\")";
anywheresoftware.b4a.keywords.Common.LogImpl("211927564","Antranor görüşleri eklendi",0);
RDebugUtils.currentLine=11927565;
 //BA.debugLineNum = 11927565;BA.debugLine="StartActivity(AntranorGorusListele)";
...
RDebugUtils.currentLine=11927566;
 //BA.debugLineNum = 11927566;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 }else 
{RDebugUtils.currentLine=11927567;
 //BA.debugLineNum = 11927567;BA.debugLine="Else If result= DialogResponse.NEGATIVE Then";
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.NEGATIVE) { 
RDebugUtils.currentLine=11927568;
 //BA.debugLineNum = 11927568;BA.debugLine="ToastMessageShow(\"Yönlendiriliyorsunuz...\",False";
...
RDebugUtils.currentLine=11927569;
 //BA.debugLineNum = 11927569;BA.debugLine="Return";
if (true) return "";
 }}
;
...
RDebugUtils.currentLine=11862016;
 //BA.debugLineNum = 11862016;BA.debugLine="Sub ID";
RDebugUtils.currentLine=11862017;
 //BA.debugLineNum = 11862017;BA.debugLine="Dim sf As StringFunctions";
_sf = new adr.stringfunctions.stringfunctions();
RDebugUtils.currentLine=11862018;
 //BA.debugLineNum = 11862018;BA.debugLine="sf.initialize";
_sf._initialize(processBA);
RDebugUtils.currentLine=11862020;
 //BA.debugLineNum = 11862020;BA.debugLine="rs= Main.sql.ExecQuery(\"SELECT * FROM AntranorGor";
mostCurrent._rs.setObject((android.database.Cursor)(mostCurrent._main._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT * FROM AntranorGorusleri ORDER BY antranorGorüsleri_id DESC")));
RDebugUtils.currentLine=11862021;
 //BA.debugLineNum = 11862021;BA.debugLine="If rs.RowCount>0 Then";
if (mostCurrent._rs.getRowCount()>0) { 
RDebugUtils.currentLine=11862022;
 //BA.debugLineNum = 11862022;BA.debugLine="rs.Position=0";
mostCurrent._rs.setPosition((int) (0));
RDebugUtils.currentLine=11862023;
 //BA.debugLineNum = 11862023;BA.debugLine="AntranorGorusleriID = sf.Right(\"00\" &sf.Trim(sf.";
_antranorgorusleriid = (int)(Double.parseDouble(_sf._vvvvv7("00"+_sf._vvvvvvv4(BA.NumberToString(_sf._vvvvvvv6(_sf._vvvvv7(mostCurrent._rs.GetString("antranorGorüsleri_id"),(long) (3)))+1)),(long) (3))));
 }else {
RDebugUtils.currentLine=11862025;
 //BA.debugLineNum = 11862025;BA.debugLine="AntranorGorusleriID=\"001\"";
_antranorgorusleriid = (int)(Double.parseDouble("001"));
 };
RDebugUtils.currentLine=11862027;
 //BA.debugLineNum = 11862027;BA.debugLine="rs.Close";
