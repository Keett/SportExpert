...
public class dayanikliliktestmenu extends Activity implements B4AActivity{
	public static dayanikliliktestmenu mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example3", "b4a.example3.dayanikliliktestmenu");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (dayanikliliktestmenu).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example3", "b4a.example3.dayanikliliktestmenu");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example3.dayanikliliktestmenu", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (dayanikliliktestmenu) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (dayanikliliktestmenu) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return dayanikliliktestmenu.class;
	}
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (dayanikliliktestmenu) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            dayanikliliktestmenu mc = mostCurrent;
...
public anywheresoftware.b4a.objects.ButtonWrapper _buttonprogram = null;
public anywheresoftware.b4a.objects.LabelWrapper _labelprogram = null;
public anywheresoftware.b4a.objects.ButtonWrapper _buttondayanikliliktest = null;
public anywheresoftware.b4a.objects.LabelWrapper _labeldayanikliliktest = null;
...
RDebugUtils.currentModule="dayanikliliktestmenu";
if (Debug.shouldDelegate(mostCurrent.activityBA, "activity_create", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "activity_create", new Object[] {_firsttime}));}
RDebugUtils.currentLine=22413312;
 //BA.debugLineNum = 22413312;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=22413314;
 //BA.debugLineNum = 22413314;BA.debugLine="Activity.LoadLayout(\"DayaniklilikTestMenuPage\")";
mostCurrent._activity.LoadLayout("DayaniklilikTestMenuPage",mostCurrent.activityBA);
RDebugUtils.currentLine=22413316;
 //BA.debugLineNum = 22413316;BA.debugLine="LabelDayaniklilikTest.Text = \"DAYANIKLILIK TEST\"";
mostCurrent._labeldayanikliliktest.setText(BA.ObjectToCharSequence("DAYANIKLILIK TEST"));
RDebugUtils.currentLine=22413317;
 //BA.debugLineNum = 22413317;BA.debugLine="LabelDayaniklilikTest.TextColor = Colors.White";
mostCurrent._labeldayanikliliktest.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
RDebugUtils.currentLine=22413318;
 //BA.debugLineNum = 22413318;BA.debugLine="LabelDayaniklilikTest.TextSize = 20";
mostCurrent._labeldayanikliliktest.setTextSize((float) (20));
RDebugUtils.currentLine=22413319;
 //BA.debugLineNum = 22413319;BA.debugLine="LabelDayaniklilikTest.Typeface = Typeface.DEFAULT";
mostCurrent._labeldayanikliliktest.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD);
RDebugUtils.currentLine=22413321;
 //BA.debugLineNum = 22413321;BA.debugLine="LabelProgram.Text = \"PROGRAM\"";
mostCurrent._labelprogram.setText(BA.ObjectToCharSequence("PROGRAM"));
RDebugUtils.currentLine=22413322;
 //BA.debugLineNum = 22413322;BA.debugLine="LabelProgram.TextColor = Colors.White";
mostCurrent._labelprogram.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
RDebugUtils.currentLine=22413323;
 //BA.debugLineNum = 22413323;BA.debugLine="LabelProgram.TextSize = 20";
mostCurrent._labelprogram.setTextSize((float) (20));
RDebugUtils.currentLine=22413324;
 //BA.debugLineNum = 22413324;BA.debugLine="LabelProgram.Typeface = Typeface.DEFAULT_BOLD";
mostCurrent._labelprogram.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD);
RDebugUtils.currentLine=22413326;
 //BA.debugLineNum = 22413326;BA.debugLine="End Sub";
return "";
}
public static String  _activity_pause(boolean _userclosed) throws Exception{
RDebugUtils.currentModule="dayanikliliktestmenu";
RDebugUtils.currentLine=22544384;
 //BA.debugLineNum = 22544384;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
...
RDebugUtils.currentLine=22478848;
 //BA.debugLineNum = 22478848;BA.debugLine="Sub Activity_Resume";
...
RDebugUtils.currentLine=22872064;
 //BA.debugLineNum = 22872064;BA.debugLine="Sub ButtonAnasayfa_Click";
RDebugUtils.currentLine=22872065;
 //BA.debugLineNum = 22872065;BA.debugLine="StartActivity(AnaMenu)";
...
RDebugUtils.currentLine=22675456;
 //BA.debugLineNum = 22675456;BA.debugLine="Sub ButtonDayaniklilikTest_Click";
RDebugUtils.currentLine=22675457;
 //BA.debugLineNum = 22675457;BA.debugLine="StartActivity(DayaniklilikTestListele)";
...
public static String  _buttonprogram_click() throws Exception{
RDebugUtils.currentModule="dayanikliliktestmenu";
if (Debug.shouldDelegate(mostCurrent.activityBA, "buttonprogram_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "buttonprogram_click", null));}
RDebugUtils.currentLine=22609920;
 //BA.debugLineNum = 22609920;BA.debugLine="Sub ButtonProgram_Click";
RDebugUtils.currentLine=22609921;
 //BA.debugLineNum = 22609921;BA.debugLine="StartActivity(ProgramListele)";
...
public static String  _labeldayanikliliktest_click() throws Exception{
RDebugUtils.currentModule="dayanikliliktestmenu";
if (Debug.shouldDelegate(mostCurrent.activityBA, "labeldayanikliliktest_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "labeldayanikliliktest_click", null));}
RDebugUtils.currentLine=22740992;
 //BA.debugLineNum = 22740992;BA.debugLine="Sub LabelDayaniklilikTest_Click";
RDebugUtils.currentLine=22740993;
 //BA.debugLineNum = 22740993;BA.debugLine="ButtonDayaniklilikTest_Click";
_buttondayanikliliktest_click();
RDebugUtils.currentLine=22740994;
 //BA.debugLineNum = 22740994;BA.debugLine="End Sub";
return "";
}
public static String  _labelprogram_click() throws Exception{
RDebugUtils.currentModule="dayanikliliktestmenu";
if (Debug.shouldDelegate(mostCurrent.activityBA, "labelprogram_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "labelprogram_click", null));}
RDebugUtils.currentLine=22806528;
 //BA.debugLineNum = 22806528;BA.debugLine="Sub LabelProgram_Click";
RDebugUtils.currentLine=22806529;
 //BA.debugLineNum = 22806529;BA.debugLine="ButtonProgram_Click";
